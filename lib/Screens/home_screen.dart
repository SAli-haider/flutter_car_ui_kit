...
import 'package:tesla_ui_kit/Components/battery_status.dart';
import 'package:tesla_ui_kit/Components/bottom_navigation.dart';
import 'package:tesla_ui_kit/Components/door_lock.dart';
import 'package:tesla_ui_kit/Components/temp_status.dart';
import 'package:tesla_ui_kit/Components/tyrePsiCard.dart';
import 'package:tesla_ui_kit/Components/tyres.dart';
import 'package:tesla_ui_kit/Model/TyrePsi.dart';
import 'package:tesla_ui_kit/constants.dart';
import 'package:tesla_ui_kit/home_controller.dart';
                    ...
                    children: [
                      ...
                      AnimatedPositioned(
                        ...
                        child: AnimatedOpacity(
                          ...
                          child: DoorLock(
                            lockKey: const ValueKey("rightLock"),
                            unlockKey: const ValueKey("rightUnLock"),
                      ...
                      AnimatedPositioned(
                        ...
                        child: AnimatedOpacity(
                          ...
                          opacity: _controller.selectedBottomTab == 0 ? 1 : 0,
                          child: DoorLock(
                            lockKey: const ValueKey("leftLock"),
                            unlockKey: const ValueKey("leftUnLock"),
                      ...
                      AnimatedPositioned(
                        ...
                        child: AnimatedOpacity(
                          ...
                          opacity: _controller.selectedBottomTab == 0 ? 1 : 0,
                          child: DoorLock(
                            lockKey: const ValueKey("topLock"),
                            unlockKey: const ValueKey("topUnLock"),
                      ...
                      AnimatedPositioned(
                        ...
                        child: AnimatedOpacity(
                          ...
                          opacity: _controller.selectedBottomTab == 0 ? 1 : 0,
                          child: DoorLock(
                            lockKey: const ValueKey("bottomLock"),
                            unlockKey: const ValueKey("bottomUnLock"),
